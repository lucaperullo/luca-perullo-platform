 ...
 *
 * Server-side update del profilo utente. Usato dal ProfileForm su
 * /profilo. Bypassa eventuali estensioni browser che bloccano richieste
 * PATCH/POST cross-origin verso Supabase (stesso pattern di
...
export async function POST(req: Request) {
    ...
    // Validazione + sanitizzazione (gli stessi vincoli del check su DB).
    const fullName =
