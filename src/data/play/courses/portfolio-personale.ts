...
<html lang="it">
  ...
  <body>
    ...
    // ────────────── MODULO 2: NAV STICKY + HERO + ABOUT ──────────────────
    {
        ...
        avatarMood: "talking",
        script:
            "Apri il sito di Apple, di Stripe, di Linear: hanno tutte la stessa cosa. La nav che resta in alto mentre scrolli, ma semi-trasparente, con un effetto vetro come una vetrina ghiacciata. Lo facciamo anche noi. Tre regole CSS: position sticky con top zero la incolla in alto, backdrop-filter blur fa l'effetto vetro, e qualche stile per i link. Dettaglio piccolo, impatto enorme.",
        instruction:
...
<html lang="it">
  ...
  <body>
...

    {
        ...
        avatarMood: "talking",
        script:
            "Anna non è un brand astratto, è una persona. E le persone vendono se stesse meglio guardando in faccia chi le sceglie. Per questo l'hero del portfolio mette sempre la foto. La nostra setup: CSS Grid a 2 colonne, foto a sinistra, nome e bio a destra. Il titolo è gigante con clamp, perché ridimensiona da solo tra mobile e desktop. La foto la prendiamo da picsum come placeholder — quando il sito sarà di Anna vera, basta sostituirla.",
        instruction:
...
<html lang="it">
  ...
  <body>
    ...
    // ────────────── MODULO 3: ABOUT + PROJECTS + CONTATTO ────────────────
    {
        ...
        avatarMood: "talking",
        script:
            "Adesso il pezzo che racconta chi è Anna. Titolo grosso, due paragrafi che si leggono in 30 secondi, e una fila di competenze in tag — il modo più moderno per dire \"queste cose le so fare\". Trucco di leggibilità: limitiamo la larghezza a 720 pixel. Il testo lungo a tutta pagina stanca gli occhi, righe più corte si leggono al doppio della velocità. È uno standard editoriale, vale anche sul web.",
        instruction:
